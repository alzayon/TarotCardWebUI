...
export const CATEGORY_LOAD_DONE_NOT_FOUND: string = "CARD_LOAD_DONE_NOT_FOUND";
...
export class LoadCategoryDoneNotFoundAction implements Action {
    readonly type = CATEGORY_LOAD_DONE_NOT_FOUND;
